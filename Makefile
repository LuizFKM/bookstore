...
help:  ## Display this help
	...
	@echo   deps-py-update     - Update Poetry deps
	@echo   deps               - Installs all dependencies
	@echo   check              - Runs linters and other important tools
	@echo   check-py           - Checks only Python files
	@echo   check-py-flake8    - Runs flake8 linter
	@echo   check-py-black     - Runs black in check mode (no changes)
	@echo   check-py-mypy      - Runs mypy
	@echo   format-py          - Runs black, makes changes where necessary
	@echo   format-autopep8    - Runs autopep8
	@echo   format-isort       - Runs isort
